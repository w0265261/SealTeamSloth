...
if(((_house getVariable "house_owner") select 0) == getPlayerUID player) exitWith { hint "The IA department will hear about this. You best tender your resignation ASAP if you want to keep some dignity. You should be ashamed of yourself."; };
