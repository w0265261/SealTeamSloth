...
_dealer = switch(_this select 0) do {
	case Dealer_2: {"Ifestonia"};
	case Dealer_1: {"Negades"};
	case Dealer_3: {"Pyrgos"};
};
_names = "";
{
	[_x select 0,_x select 1,"904",[name player,_dealer]] remoteExec ["life_fnc_wantedAdd",2];
