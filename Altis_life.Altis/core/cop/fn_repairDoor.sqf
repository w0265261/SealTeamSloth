...
*/
if(typeOf cursorTarget in["Land_MilOffices_V1_F"]) then { cursorTarget setVariable["bis_disabled_door_4",1,true]; hint "You have locked the vault room"; closeDialog 0; } else {
