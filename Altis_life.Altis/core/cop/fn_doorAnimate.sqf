if(typeOf cursorTarget in["Land_MilOffices_V1_F"]) then { cursorTarget setVariable["bis_disabled_door_4",0,true]; hint "You have unlocked the vault room"; closeDialog 0;} else {
