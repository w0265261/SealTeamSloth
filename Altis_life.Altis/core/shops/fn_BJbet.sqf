...
switch ( _betamt ) do 
{
	...
	case 2500: { _bet10KTEXT ctrlSetText ""; _bet5KTEXT ctrlSetText ""; _bet50KTEXT ctrlSetText ""; };
	case 5000: { _bet10KTEXT ctrlSetText ""; _bet25KTEXT ctrlSetText ""; _bet5KTEXT ctrlSetText ""; };
...
{ 
	_win = 2.5 * _betamt;
	["cash","add",_win] call life_fnc_handlePaper;	
	_winnings ctrlSetText format["You won $%1!",_win];
