...
if(life_handpaper < 20) exitWith {hint "You do not have enough money to initiate a skydive!";};
_check = false; 
{if(player distance _x < 300 && side _x == west && life_wanted) exitWith { _check = true; };} forEach playableUnits; 
