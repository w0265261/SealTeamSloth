...
if(parseNumber(_amount) > 300000) exitWith { hint "You can not send/take more than $300,000 in a single instance."; };

[_type,parseNumber(_amount),profileName] remoteExec ["life_fnc_compAction",life_compTarget,false];
if(_type == 0) then {
