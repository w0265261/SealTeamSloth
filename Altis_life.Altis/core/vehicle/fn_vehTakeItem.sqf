...
{
    /*_msg = format["Hack Alert %1 and %2 appear to be using a vehicle trunk at the same time to duplicate items, this action has been stopped!",life_trunk_vehicle getVariable "trunkUsersName",profileName];
