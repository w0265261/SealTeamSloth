class STS_KBW_Duel
{
	...
	onLoad = "[] spawn {waitUntil {dialog}; ctrlShow[100,false]};";
	...
	class controls {
		...
		class RscButtonMenu_2402: Life_RscButtonMenu
		{
			idc = 100;
			text = "Add Racer";
			onButtonClick = "if(lbCurSel 15101 == -1) exitWith {hint localize 'STR_Global_NoSelection'}; _unit = lbData[15101,(lbCurSel 15101)]; _unit = call compile format['%1',_unit]; if(_unit in life_racers || vehicle _unit == _unit) exitWith {}; life_racers pushBack _unit; ctrlShow[101,true]; _out = ''; {_toAdd = name _x + ' '; _out = _out + _toAdd} forEach life_racers; hint format['Current Racers: %1',_out];";
