class STS_Life_lease {
	idd = 2700;
	name= "life_lease";
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[] spawn life_fnc_leaseMenu;";
	...
	class controls {
		...
		class LeasersList : Life_RscListBox 
		{
			idc = 2701;
			text = "";
			sizeEx = 0.035;
		...
		class DropKey : life_RscButtonMenu {
			...
			text = "Remove Leaser";
			colorBackground[] = {0,0.2235294117647059,0.3725490196078431,1};
			onButtonClick = "[0] call life_fnc_manageLeasing";
		...
		class GiveKey : Life_RscButtonMenu {
			...
			text = "Add Leaser";
			colorBackground[] = {0,0.2235294117647059,0.3725490196078431,1};
			onButtonClick = "[1] call life_fnc_manageLeasing";
			x = 0.32;
			y = 0.69;
			w = (6.25 / 40);
			h = (1 / 25);
