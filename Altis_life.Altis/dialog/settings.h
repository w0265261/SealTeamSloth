class STS_SettingsMenu
{
	...
	class controlsBackground
	{
		...
		class EnvironmentHeader : PlayerTagsHeader
		{
			idc = -1;
		...
		class ScriptWeaponStateHeader : PlayerTagsHeader
		{
			idc = -1;
			text = "Grass";
	...
	class controls
	{
		...
		{
			idc = 2971;
			tooltip = "Disable/Enable Side Chat";
		...
		{
			tooltip = "Enable/disable environmental effects (ambient life + sound). May increase performance.";
			idc = 2972;
			action = "[] call life_fnc_environment;";			
			y = 0.53;
		};
		class ScriptWeaponStateONOFF : PlayerTagsONOFF
		{
			toolTip = "Disable/Enable Grass.";
			action = "if(isNil 'myGrassCheck') then {myGrassCheck = true; findDisplay 2900 displayCtrl 2973 ctrlSetText 'ON'; findDisplay 2900 displayCtrl 2973 ctrlSetTextColor [0,1,0,1]; setTerrainGrid 25} else {myGrassCheck = nil; findDisplay 2900 displayCtrl 2973 ctrlSetText 'OFF'; findDisplay 2900 displayCtrl 2973 ctrlSetTextColor [1,0,0,1]; setTerrainGrid 50};";
			text = "ON";
			color[] = {0, 1, 0, 1};
			idc = 2973;
			y = 0.58;
