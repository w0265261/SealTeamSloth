...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Supply_CrateAir = ["B_supplyCrate_F", "IG_supplyCrate_F", "O_supplyCrate_F", "I_supplyCrate_F"];
	IL_Supported_Supply_CrateGround = ["B_supplyCrate_F", "IG_supplyCrate_F", "O_supplyCrate_F", "I_supplyCrate_F", "C_supplyCrate_F", "Land_PlasticCase_01_large_F", "CargoNet_01_box_F"];
	...
	IL_Supported_Cargo_NonVeh_Offroad = IL_Supported_Supply_CrateGround + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2;
	...
	IL_Supported_Cargo_NonVeh_Kamaz = IL_Supported_Supply_CrateGround + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20;
	...
	IL_Supported_Cargo_NonVeh_Mohawk = IL_Supported_Supply_CrateAir + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H2;
...
/*	END IL_Cargo_Para*/
	...
	IL_Do_Load =
	{
		...
		private["_NoBoxHint", "_v", "_supported_cargo", "_zload", "_x_cargo_offset", "_cargo_offset", "_sdist", "_spoint", "_slot_num", "_counter", "_done", "_obj_lst", "_damage", "_obj_type", "_doors", "_box_num", "_dummy", "_nic", "_turn", "_force", "_cargo","_vtrunk"];
		...
		if (!(locked _v > 1) && isNull life_escort) then {
		...
		{
			{
				...
				if (count (_vtrunk select 0) < 1 || typeOf _x in ["I_supplyCrate_F","Box_IND_Wps_F"]) then
				{
				if (IL_DevMod) then
				{
				...
				} else { hint "You can not load a vehicle which has cargo in its trunk."; };
		...
		} else { hint "An error occurred. Either the vehicle was locked or the cargo is currently being escorted."; _v setVariable["can_load", true, true]; };
	};
/*	END IL_Do_Load*/
